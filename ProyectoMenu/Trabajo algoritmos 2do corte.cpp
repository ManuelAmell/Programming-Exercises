...
{	 
	...
	cout<<endl;	
	cout<<"Tiene todo tipo de validaciones para evitar el ingreso de valores errados "<<endl;
	cout<<endl;
	cout<<"ademas, esta diseñado para que cualquiera pueda utilizarlo "<<endl;
	cout<<endl;

	
	cout<<"---INTEGRANTES---"<<endl;
	cout<<"Samuel Cogollo Villarreal -  codigo 0222420018"<<endl;
	cout<<"Manuel Amell - codigo 0222421001"<<endl;
	cout<<"Brayan Ochoa - codigo  0222421003"<<endl;
	cout<<"Jesus Barujcal - codigo 0222420033"<<endl;
	system("pause");
	system("cls");	 
	...
	do
	{
		...
		{
			system("cls");
			cout<<"Ingrese la cantidad de vidas que tendra el usuario: "<<endl;
			cin>>vidas;
			if (vidas<=0)
			{
		...
		switch (opc)
		{
			case 1:
			{
				...
				{
					cout<<endl;
    				cout<<" El numero generado fue el 1 !!! , Dato Curioso: El número 1 no es primo ni compuesto !!!" << endl;
    				cout<<"Presione enter para continuar..." << endl;
    				system("pause");
				}
				else if(divisores_numerito==2) // si numerito era primo
				{
					primos++;
					cout<<endl;
					...
					system("cls");
					cout<<endl;
					cout<<"Los numeros primos son aquellos mayores que 1 que solo tienen dos divisores: 1 y ellos mismos."<<endl;
					cout<<endl;
					...
					do
					{
						...
						switch(opc_primos)
						{
							...
							{	cout<<" Se dice que un numero primo (Pw) es de Wagstaff si se puede expresar como: Pw = (2^p + 1) / 3."<<endl;
								cout<<endl;
								cout<<"donde p es un numero primo y P tambien debe resultar ser un numero primo"<<endl;
								cout<<endl;
								cout<<"La potenciación: es una operación que consiste en multiplicar por sí mismo un número principal  llamado base, tantas veces como lo indique otro número que se llama exponente."<<endl;
								cout<<endl;
								cout<<"Para calcular la potencia de un número lo que hacemos es multiplicar dicho número por sí mismo tantas veces como indique el exponente."<<endl;
								cout<<endl;
							...
							{
								cout<<"Se dice que un numero primo es de Sophie Germain si se puede  expresar como: Pg = 2p + 1"<<endl;
								cout<<endl;
								cout<<"donde p es un numero primo y P tambi?n debe resultar ser un numero primo"<<endl;
								cout<<endl;
							...
							{
								cout<<"Se dice que un numero primo (Pm) es de Mersenne si se puede expresar como:  Pm = 2^p - 1"<<endl;
								cout<<endl;
								cout<<"donde p es un numero primo y P tambien debe resultar ser un numero primo"<<endl;
								cout<<endl;
				...
				else if (numerito>2)
				{
					...
					system("cls");
					cout<<endl;
					cout<<"Los numeros compuestos son aquellos numeros naturales mayores que 1 que tienen mas de dos divisores distintos."<<endl;
					cout<<"Es decir, ademas de ser divisibles entre 1 y ellos mismos, tambien lo son entre al menos otro numero."<<endl;
					cout<<endl;
					cout<<"Los numeros compuestos son importantes porque permiten descomponer cualquier numero en factores primos."<<endl;
					cout<<"lo que es fundamental para hacer calculos como el munimo com?n multiplo (MCM) y el maximo comun divisor (MCD)."<<endl;
					cout<<endl;
					cout<<"A continuacion mostraremos los divisores del numero y su descomposicion en factores primos!"<<endl;
					if (numerito%2==0)
					{
						par++;
					}else 
				...
				else
				{
					...
					else if (menu_opc == 2)
					{
						...
						else
						{
							...
							cout<<"Redirigiendo automaticamente a la siguiente pagina"<<endl;
							system("pause");
							menu_opc=2;
						}
