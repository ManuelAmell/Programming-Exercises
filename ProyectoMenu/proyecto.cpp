...
int main(){
    ...
    if (cin.fail() || cedula < 1 || cedula > 9999999999)//solo funciona hasta 10 digitoslo cual es suficientey detecta si la entrada es invalida 
    {
        cout << "\033[31 Cedula  invalida o vacia solo se aceptan diez digitos \033[0m\n";
        cout <<"Saliendo...";
        Sleep(1500);
        exit (0);
    }
    ...
    cout<<"Por favor, ingrese su estrato social :"; // Validar que el usuario este en el rango de los estratos a beneficiar
    cin>>estrato;
	...
	cout<<"Ingrese sus ingresos mensuales (Personales o Familiares)\n"; // Validar que el usuario cumpla los requisitos de ingresos mensuales
	cin>>ingresos_M;
    ...
    cout << left << setw(30) << "4) De dos pisos esquinera"
         ...
         switch (opcionm1)
         {
             ...
             case 3:
             {
                ...
                cin >> jardin;
                if (jardin == 1)//tambien se podia usar switch es un poco menos eficiente como esta pero se dejo para variar
                {
        ...
        if (tiempo_financiacion !=5 || tiempo_financiacion !=7 || tiempo_financiacion !=10)//validador de entrada de tiempo de financiacion
        {
            cout << "\033[31mDato invalido \033[0m\n";
			cout <<"Saliendo..";
            Sleep(1500);
       ...
       case 5:
        {
        	interes_A= 0;//temporalmente mientras se espera una respuesta de nohemy
            break;
		}
        case 7:
		{
		...
		interes_M = interes_A / 12; // Calculo del interes mensual en base a el interes anual
