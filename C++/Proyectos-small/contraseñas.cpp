...
void AgregarContacto() {
    ...
    do{Centrado("Contraseña :");
    cout << "                                                                                                            > ";
    getline(cin, NuevaAgenda[cantidad].contraseña);
    if (NuevaAgenda[cantidad].contraseña.empty()) {
        Centrado("\033[31mla contraseña no puede estar vacia. Intenta de nuevo.\033[0m");
    }
    ...
    if (existeE) {
        ...
        if (opcion == 's') {
            ...
            cout<<"\033[33mSitio anterior : \033[0m"+agenda[indiceExistente].sitio<<endl;
            cout << "Ingresa el nuevo nombre del sitio: ";
            getline(cin, agenda[indiceExistente].sitio);

            cout <<"\033[33mTelefono anterior : \033[0m"+agenda[indiceExistente].email<<endl;
            cout << "Ingresa el nuevo telefono: ";
            getline(cin, agenda[indiceExistente].email);

            cout<<"\033[33mEmail / Correo anterior : \033[0m"+agenda[indiceExistente].contraseña<<endl;
...
void BuscarContactos(){
    ...
    for (int i = 0; i < cantidad; i++) {
        ...
        else if (TodoMinusculas(agenda[i].contraseña) == TodoMinusculas(ebuscado)) {
            Centrado("\nContacto encontrado:\n");
            Centrado("Nombre : " + agenda[i].sitio);
            Centrado("Tel    : " + agenda[i].email);
            Centrado( "Email  : " + agenda[i].contraseña);
...
void VerContactos() {
    ...
    for (int i = 0; i < cantidad; i++) {
        ...
        string contacto = "| "+to_string(i + 1) + " ) Nombre: " + agenda[i].sitio
